...
assert(
  stdout.value ===
    `{"deployment":{"id":"44444444-4444-4444-8444-444444444444","repository":{"fullName":"acme/web"},"commitSha":"${commitSha}","environment":"production","newlyDeployedSessions":3}}\n`,
